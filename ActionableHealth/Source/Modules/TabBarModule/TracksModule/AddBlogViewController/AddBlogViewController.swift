    ...
    override var keyCommands: [UIKeyCommand] {
        ...
        if richTextView.isFirstResponder {
            return [ UIKeyCommand(input:"B", modifierFlags: .command, action:#selector(toggleBold), discoverabilityTitle:NSLocalizedString("Bold", comment: "Discoverability title for bold formatting keyboard shortcut.")),
                     ...
                     UIKeyCommand(input:"U", modifierFlags: .command, action:#selector(AddBlogViewController.toggleUnderline(_:)), discoverabilityTitle: NSLocalizedString("Underline", comment:"Discoverability title for underline formatting keyboard shortcut.")),
...
extension AddBlogViewController : TextViewFormattingDelegate {
...
extension AddBlogViewController {
    enum EditMode {
        case richText
        case html
...
extension AddBlogViewController : FormatBarDelegate {
    ...
    func showLinkDialog(forURL url: URL?, text: String?, range: NSRange, allowTextEdit: Bool = true) {
        ...
        alertController.addTextField(configurationHandler: { [weak self]textField in
            ...
            textField.addTarget(self,
                                action:#selector(AddBlogViewController.alertTextFieldDidChange),
...
extension AddBlogViewController: TextViewAttachmentDelegate{
...
// MARK: - Unknown HTML
//
private extension AddBlogViewController {
...
//
extension AddBlogViewController: UIPopoverPresentationControllerDelegate {
...
extension FormattingIdentifier {
    ...
    private func gridicon(_ gridiconType: GridiconType) -> UIImage {
        let size = AddBlogViewController.Constants.formatBarIconSize
