...
//                self.getNavigationController()?.popViewController(animated: true)
    ...
    func updateTitleHeight() {
        ...
        print("titletextView - \(titleHeightConstraint.constant)")
    ...
    private func configureConstraints() {
        ...
        titleHeightConstraint = titleTextView.heightAnchor.constraint(equalToConstant: ceil(titleTextView.font!.lineHeight) + 20)
        ...
        NSLayoutConstraint.activate([
            ...
            editorView.bottomAnchor.constraint(equalTo: layoutGuide.bottomAnchor, constant: -60)
    ...
    func hideDeleteButtonView(){
        DispatchQueue.main.async {
            ...
            UIView.animate(withDuration: 0.2, animations: {
                self.commentButtonBgView.alpha = 0
    ...
    override var keyCommands: [UIKeyCommand] {
        ...
        if richTextView.isFirstResponder {
            return [ UIKeyCommand(input:"B", modifierFlags: .command, action:#selector(toggleBold), discoverabilityTitle:NSLocalizedString("Bold", comment: "Discoverability title for bold formatting keyboard shortcut.")),
                     ...
                     UIKeyCommand(input:"U", modifierFlags: .command, action:#selector(BlogViewController.toggleUnderline(_:)), discoverabilityTitle: NSLocalizedString("Underline", comment:"Discoverability title for underline formatting keyboard shortcut.")),
...
extension BlogViewController : TextViewFormattingDelegate {
...
extension BlogViewController : UITextFieldDelegate {
...
extension BlogViewController : FormatBarDelegate {
    ...
    func showLinkDialog(forURL url: URL?, text: String?, range: NSRange, allowTextEdit: Bool = true) {
        ...
        alertController.addTextField(configurationHandler: { [weak self]textField in
            ...
            textField.addTarget(self,
                                action:#selector(BlogViewController.alertTextFieldDidChange),
...
extension BlogViewController: TextViewAttachmentDelegate{
...
extension BlogViewController: UINavigationControllerDelegate
{
}
...
//
extension BlogViewController: UIPopoverPresentationControllerDelegate {
